...
void dosya_S_OKU();	 //Dosyada Siginmacilari kayitlarin diziye okur
void dosya_M_OKU();	 //Dosyada Kullanici kayitlarin diziye okur
void dosya_S_ARAMA();
void dosya_M_ARAMA();
void menu_S_Arama();
void menu_M_Arama();
...
void Siginmaci_Kayit()
{
	...
	do
	{
		...
		do
		{ //tarih formatinda oldugunu kontrol ediyoruz
...
//Girilenin sayi olup olmadiðini kontrol eder.
bool d_sayi_control(char *x)
{
	bool Checked = true;
	int i = 0;
...
//Girilenin Harf olup olmadiðini kontrol eder.
bool d_harf_control(char *x)
{
	bool Checked = true;
	int i = 0;
...
//Dosyada siginmacilari kayitlarin diziye okur
void dosya_S_OKU()
{
	FILE *di;
	unsigned int tane;
...
//Dosyada Kullanici kayitlarin diziye okur
void dosya_M_OKU()
{
	FILE *di;
	//unsigned int tane;
